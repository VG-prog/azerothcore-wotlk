...
extern void TC9UpdateGroupMemberState(TC9RawPlayerGuid memberGuid, uint8_t online, uint8_t level, uint8_t playerClass, uint32_t zoneId, uint32_t mapId, uint32_t health, uint32_t maxHealth, uint8_t powerType, uint32_t power, uint32_t maxPower);
